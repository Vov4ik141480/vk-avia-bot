...
class UserData(Period, City, Date):
    ...
    def send_proof(self, user_id, user_data):
        ...
        collected_data = selection_confirmation.get_check_message(depart_city, arrive_city, departure_date)
    ...
    def get_depart_city(self, user_id, user_message, key_word):
        ...
        """
        try:
            city_name, airport_code = self.check_city(user_id, user_message, message_for_depart)
        except:
            return
        else:
    ...
    def get_arrive_city(self, user_id, user_message, key_word):
        ...
        """
        try:
            city_name, airport_code = self.check_city(user_id, user_message, message_for_arrive)
        except:
            return
        else:
            self.set_city(user_id, key_word, city_name, airport_code)
    ...
    def get_proof(self, user_id, user_message):
        ...
        if user_message == "да":
            ...
            formatted_data = selection_confirmation.verified_user_data(user_id, complit_data)
